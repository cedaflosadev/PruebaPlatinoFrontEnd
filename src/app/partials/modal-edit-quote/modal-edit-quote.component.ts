...
@Component({
  selector: "app-modal-edit-quote",
  templateUrl: "./modal-edit-quote.component.html",
  styles: [],
})
export class ModalEditQuoteComponent implements OnInit {
  public formUpdateQuotes: FormGroup;
  public formUpdateQuotesErrors: QuotesModel = new QuotesModel();
  public clients = [];
  constructor(
    public dialogRef: MatDialogRef<ModalEditQuoteComponent>,
  ...
  public CreateForm() {
    this.formUpdateQuotes = this.formBuilder.group({
      ...
      date_quote: [
        { value: this.data.date_quote, disabled: false },
        [Validators.required],
      ],
      hour_quote: [
        { value: this.data.hour_quote, disabled: false },
        [Validators.required],
      ],
      state: [
        { value: this.data.state, disabled: false },
        [Validators.required],
      ],
